      ...
      return (
        <div className="media border p-1 mt-1 mb-1" key={index}>
          <div className="media-body">
            <h5  style={{color:'#203181',fontWeight:'bold'}}>{post.tenChuNha} | <span class="badge badge-light"> Hình thức:{post.hinhThuc}</span> | <span class="badge badge-light"> Lương: {post.salary}</span>  <span class="badge badge-info" >{post.diaChi}</span> </h5>
  ...
  renderTop5 = () => {
    return top5.map((top,index) => {
      return (
        <div className="media border p-1  mt-1 mb-1" key={index}>
        <div className="media-body">
          <h5  style={{color:'#203181',fontWeight:'bold'}}> {top.tenUngVien} | <span className="badge badge-light"> {top.tuoi} Tuổi </span>  </h5>
    ...
    return (
      <div className="container-fluid">
        <div className="row  w-100 pb-3 pl-0 pr-0">
          ...
          <h3 className="p-3 text-center" style={{color:'#203181',fontWeight:'bold'}} >TOP BÀI ĐĂNG MỚI NHẤT</h3>
              {this.renderPost()}
          ...
          <div className="col-3 border">
             <h4 className="p-3 mb-4 text-center" style={{color:'#203181',fontWeight:'bold'}} >TOP 5 ỨNG VIÊN XUẤT SẮC</h4>
